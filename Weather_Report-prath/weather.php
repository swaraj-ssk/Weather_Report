...
<body>
    ...
    <div class="block">
        <div class="rem">
           <h3> <p><?php echo $day1_temp = $data['list'][1]['main']['temp']." °C";?></p>
            <p>Temperature after 3 hrs</p></h3>
        </div>
        <div class="rem">
            <h3><p><?php echo $day1_temp = $data['list'][2]['main']['temp']." °C";?></p>
            <p>Temperature after 6 hrs</p></h3>
        </div>
        <div class="rem">
           <h3> <p><?php echo $day1_temp = $data['list'][3]['main']['temp']." °C";?></p>
            <p>Temperature after 9 hrs</p></h3>
        </div>
        <div class="rem">
          <h3>  <p><?php echo $day1_temp = $data['list'][4]['main']['temp']." °C";?></p>
            <p>Temperature after 12 hrs</p></h3>
        </div>
        <div class="rem">
           <h3> <p><?php echo $day1_temp = $data['list'][5]['main']['temp']." °C";?></p>
            <p>Temperature after 15 hrs</p></h3>
        </div>
        <div class="rem">
          <h3>  <p><?php echo $day1_temp = $data['list'][6]['main']['temp']." °C";?></p>
            <p>Temperature after 18 hrs</p></h3>
        </div>
        <div class="rem">
          <h3>  <p><?php echo $day1_temp = $data['list'][7]['main']['temp']." °C";?></p>
            <p>Temperature after 21 hrs</p></h3>
        </div>
    </div>
